      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/[0.06] px-4 py-1.5 text-xs font-mono tracking-widest text-white uppercase font-bold"
          >
          ...
          >
            Autonomous Intelligence, <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-200 to-neutral-400">Continuous Control</span> & Scalable AI.
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <TiltCard
              ...
              className="p-8 h-full flex flex-col items-center text-center justify-center relative overflow-hidden bg-[#0B0B0B] border border-white/10 shadow-2xl hover:border-white/30"
            >
              {/* Photo Frame with Real Photo */}
              <div className="relative mb-6">
                <div className="h-48 w-48 rounded-3xl p-1 bg-gradient-to-tr from-white/25 via-white/10 to-white/25 shadow-2xl">
              ...
              <h3 className="text-2xl font-black text-white mt-4">{personalData.name}</h3>
              <p className="text-xs text-neutral-300 font-mono mt-1 font-semibold">
              ...
              {/* Verified Profiles */}
              <div className="mt-6 w-full pt-4 border-t border-white/10 flex items-center justify-around text-xs font-mono text-neutral-300 font-semibold">
                <a
